...
const Banner = () => {
  ...
  return (
    <div className="lg:h-[500px] grid lg:grid-cols-2 max-w-6xl mx-auto lg:px-2 text-green-50 cursor-not-allowed p-5 lg:p-0">
      <div className="space-y-5 flex flex-col justify-center p-4 lg:p-0">
        ...
        <div className="hover:text-orange-400 ease-in-out duration-1000 space-y-2">
          <h1 className="text-2xl lg:text-4xl font-semibold">Frontend Developer</h1>
        </div>
        <p>
